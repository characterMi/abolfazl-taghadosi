  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-start gap-5 lg:gap-[1.5vw] min-h-[20vh] uppercase">
        <h1 className="text-neutral-400 font-black xss:text-xl sm:text-2xl lg:text-[1.5vw]">
          The page you are looking for doesn&apos;t exist.
        </h1>
        <h2 className="text-neutral-500 opacity-80 text-xs xss:text-base sm:text-lg lg:text-[1vw]">
