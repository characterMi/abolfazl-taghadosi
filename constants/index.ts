...
export const allTech = [
  {
    label: "React Query",
    imgSrc: "/tech/react-query.svg",
    top: "90%",
    left: "5%",
  },
  {
    label: "Framer Motion",
    imgSrc: "/tech/framer-motion.svg",
    top: "30%",
    left: "20%",
  },
  {
    label: "GSAP",
    imgSrc: "/tech/gsap.svg",
    top: "10%",
    left: "60%",
  },
  {
    label: "Prisma ORM",
    imgSrc: "/tech/prisma.svg",
    top: "25%",
    left: "0%",
  },
  {
...
export const aboutContent = [
  {
    title: "- My Journey",
    content:
      "The_joy_of_creating_something_meaningful_has_always_been_a_part_of_me._Programming_became_the_best_way_to_express_that_passion._It_was_a_natural_fit_for_my_love_of_problem-solving_and_mathematics._In_the_early_days,_my_journey_started_with_a_few_online_courses._But_it_was_on_YouTube_that_I_truly_found_my_university.(mark)_I_spent_countless_hours_learning_from_incredible_creators_and_developers_around_the_world,_building_my_skills_piece_by_piece,_project_by_project._This_path_made_me_a_self-taught_developer,_driven_by_curiosity_and_a_love_for_building_things_that_stand_out._To_me,_building_software_is_a_fusion_of_logic_and_creativity,_much_like_life_itself.",
  },
  {
  ...
  },
  {
    ...
    content: `Throughout_my_learning_journey,_there_have_been_several_individuals_who_have_had_a_profound_impact_on_my_growth_as_a_developer._Their_teaching,_guidance,_and_content_have_inspired_me_and_shaped_my_approach_to_coding._I_owe_much_of_my_progress_to_${legends
      .map(({ link, name }, index) => `${index === legends.length - 1 ? "and_" : ""}${name}(${link}link)`)
      .join(
        "_"
